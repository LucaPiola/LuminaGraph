window.STGraphXI18nBundles = {
  "it": {
    ...
    "expr.help.rand": "rand(): numero casuale uniforme tra 0 e 1. Esempio: rand().",
    ...
    "expr.hint": "Tab: indentazione, Shift+Tab: riduci, Ctrl+Enter: applica. Usa range(...), slicing stile Python e locali $0, $1, ... dentro array(...).",
  ...
  "en": {
    ...
    "expr.help.rand": "rand(): uniform random number between 0 and 1. Example: rand().",
    ...
    "expr.hint": "Tab: indent, Shift+Tab: outdent, Ctrl+Enter: apply. Use range(...), Python-style slicing, and local $0, $1, ... inside array(...).",
