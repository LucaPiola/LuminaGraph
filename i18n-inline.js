window.STGraphXI18nBundles = {
  "it": {
    ...
    "expr.help.pop": "pop(self | nodo): in un template di popolazione restituisce il vettore dei valori del nodo per tutti gli agenti. In uso standalone restituisce il valore locale. Usa pop(self) per riferirti al nodo corrente.",
    ...
    "expr.help.self": "Valore locale corrente del nodo. In un nodo vettoriale indica l'elemento corrente; usa pop(self) per riferirti al vettore completo del nodo corrente.",
    ...
    "expr.help.this": "'this' indica lo stato attuale del nodo di stato.",
    ...
    "expr.hint": "Tab: indentazione, Shift+Tab: riduci, Ctrl+Enter: applica. Usa slicing stile Python e locali $0, $1, ... dentro array(...).",
  ...
  "en": {
    ...
    "expr.help.pop": "pop(self | node): in a population template it returns the vector of that node's values across all agents. In standalone use it returns the local value. Use pop(self) for the current node.",
    ...
    "expr.help.self": "Current local node value. In a vector-valued node it refers to the current element; use pop(self) for the full vector of the current node.",
    ...
    "expr.help.this": "'this' is the current state of the state node.",
    ...
    "expr.hint": "Tab: indent, Shift+Tab: outdent, Ctrl+Enter: apply. Use Python-style slicing and local $0, $1, ... inside array(...).",
